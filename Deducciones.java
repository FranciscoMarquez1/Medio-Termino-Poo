public class Deducciones {
	...
	public void totalDeduccionesSinRetiro(){
		if (a.getColegiatura()<this.maximoDeducirColegiatura){
		this.totalDeduccionesSinRetiro=a.getMedicos()+a.getFunerarios()+a.getSggm()+a.getHipotecarios()+a.getDonativos()+a.getTransporte()+a.getColegiatura();
		}
		else {
			this.totalDeduccionesSinRetiro=a.getMedicos()+a.getFunerarios()+a.getSggm()+a.getHipotecarios()+a.getDonativos()+a.getTransporte()+this.maximoDeducirColegiatura;
		}
	}

	public void deduccionesPermitidas(){
		this.deduccionesPermitidas=(this.ingresoAnual+this.totalDeduccionesSinRetiro)*0.1;
	}
	...
	public void cuotaFija(){
		...
		else if (this.montoSobreElCualSeCalculaISR<50524.92){
			this.cuotaFija = 114.29;
		}
		else if (this.montoSobreElCualSeCalculaISR<88793.04){
			this.cuotaFija = 2966.91;
		}
		else if (this.montoSobreElCualSeCalculaISR<103218){
			this.cuotaFija = 7130.48;
		}
		else if (this.montoSobreElCualSeCalculaISR<123580.2){
			this.cuotaFija = 9438.47;
		}
		else if (this.montoSobreElCualSeCalculaISR<249243.48){
			this.cuotaFija = 13087.37;
		}
		else if (this.montoSobreElCualSeCalculaISR<392841.96){
			this.cuotaFija = 39929.05;
		}
		else if (this.montoSobreElCualSeCalculaISR<750000){
			this.cuotaFija = 73703.41;
		}
		else if (this.montoSobreElCualSeCalculaISR<1000000){
			this.cuotaFija = 180850.82;
		}
		else if (this.montoSobreElCualSeCalculaISR<3000000){
